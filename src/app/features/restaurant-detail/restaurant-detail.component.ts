...
@Component({
  ...
  `,
  styles: [`
    .hero-banner { height: 260px; background-size: cover; background-position: center; position: relative; }
    .hero-overlay { position: absolute; inset: 0; background: linear-gradient(to top, rgba(0,0,0,0.82) 0%, rgba(0,0,0,0.3) 60%, transparent 100%); }
    .hero-content { position: absolute; bottom: 0; left: 50%; transform: translateX(-50%); width: 100%; padding: 20px; }
    .restaurant-info h1 { font-size: 26px; font-weight: 700; color: white; margin-bottom: 6px; }
    .cuisine-tags { color: #ddd; font-size: 13px; margin-bottom: 8px; }
    .meta-row { display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 8px; }
    .rating-pill { display: flex; align-items: center; gap: 4px; background: #3d9b35; color: white; padding: 4px 10px; border-radius: 20px; font-size: 12px; font-weight: 600; }
    .meta-chip { display: flex; align-items: center; gap: 4px; background: rgba(255,255,255,0.15); color: white; padding: 4px 10px; border-radius: 20px; font-size: 12px; backdrop-filter: blur(4px); }
    .meta-chip mat-icon, .rating-pill mat-icon { font-size: 14px; height: 14px; width: 14px; }
    .address-row { display: flex; align-items: center; gap: 4px; color: #ccc; font-size: 12px; }
    .address-row mat-icon { font-size: 14px; height: 14px; width: 14px; }

    .content-area { display: grid; grid-template-columns: 190px 1fr; gap: 20px; padding: 20px 20px 100px; }
    ...
    .cat-title { font-size: 18px; font-weight: 700; margin-bottom: 14px; padding-bottom: 10px; border-bottom: 1px solid #f0f0f0; }
    .item-count { font-size: 13px; font-weight: 400; color: #888; }
    .menu-item { display: flex; justify-content: space-between; gap: 12px; padding: 14px 0; border-bottom: 1px solid #f8f8f8; }
    ...
    .bestseller-tag { font-size: 11px; color: #e67e22; font-weight: 600; background: #fff3e0; padding: 2px 8px; border-radius: 4px; white-space: nowrap; }
    .item-name { font-size: 14px; font-weight: 600; margin-bottom: 4px; }
    .item-price { font-size: 14px; font-weight: 600; color: #3d4152; margin-bottom: 6px; }
    .item-desc { font-size: 12px; color: #93959f; line-height: 1.4; }
    .item-right { display: flex; flex-direction: column; align-items: center; gap: 8px; flex-shrink: 0; }
    .item-img { width: 100px; height: 84px; border-radius: 10px; object-fit: cover; }
    .add-btn { background: white; border: 1.5px solid #e23744; color: #e23744; font-weight: 700; font-size: 13px; font-family: Poppins; padding: 5px 16px; border-radius: 8px; cursor: pointer; letter-spacing: 0.5px; transition: all 0.2s; }
    ...
    .cart-bar { position: fixed; bottom: 0; left: 0; right: 0; z-index: 500; }
    ...
    .view-cart-btn { display: flex; align-items: center; gap: 4px; background: #e23744; border: none; color: white; font-weight: 700; font-size: 14px; padding: 8px 18px; border-radius: 8px; cursor: pointer; font-family: Poppins; white-space: nowrap; }
    .not-found { text-align: center; padding: 80px 20px; color: #686b78; }

    @media(max-width: 768px) {
      .hero-banner { height: 200px; }
      .restaurant-info h1 { font-size: 20px; }
      .meta-row { gap: 6px; }
      .meta-chip, .rating-pill { font-size: 11px; padding: 3px 8px; }
      .content-area { grid-template-columns: 1fr; padding: 16px 16px 100px; }
