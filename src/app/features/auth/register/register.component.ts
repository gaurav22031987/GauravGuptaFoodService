    ...
    <div class="auth-page">
      <mat-card class="auth-card">
        <div class="auth-header">
          ...
          <p>Join Kitchen King Food and start ordering</p>
        </div>
...
export class RegisterComponent {
  ...
  async loginGoogle() {
    ...
    try {
      ...
      this.snackBar.open('Account created with Google!', '', { duration: 2500, panelClass: 'snack-success' });
    } catch (e: any) {
  ...
  async loginFacebook() {
    ...
    try {
      ...
      this.snackBar.open('Account created with Facebook!', '', { duration: 2500, panelClass: 'snack-success' });
    } catch (e: any) {
      this.socialError = this.getFriendlyError(e);
    } finally {
      this.socialLoading = null;
  ...
  private getFriendlyError(e: any): string {
    ...
    return 'Social login failed. Please use email/password registration.';
  }
  ...
  onSubmit() {
    ...
    setTimeout(() => {
      ...
      this.loading = false;
      if (ok) {
        this.snackBar.open('Account created! Welcome to Kitchen King Food!', '', { duration: 3000, panelClass: 'snack-success' });
